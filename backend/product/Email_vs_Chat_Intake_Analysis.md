...
Thanks for starting your Ignition Club profile! Over the next week, we'll get to know you 
...
### If we do email for Ignition Club:
...
| Dimension | JODI (Matchmaking) | Ignition Club (Recruitment) |
|-----------|-------------------|----------------------|
...
**Bottom line:**
- JODI = keep chat
- Ignition Club = go email (perfect fit, worth the cost)

**Next:** Want me to add email intake design to Ignition Club schema work (when Xing delivers)?
